...
5. **Unit test opportunities** — for each extracted mechanism candidate,
   note that unit tests should be added on the mechanism layer, and
   describe what a minimal test would look like.
